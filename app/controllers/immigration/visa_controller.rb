class Immigration::VisaController < ApplicationController
  ...
  private
    def post_params      
      defaultref = 10004102000
      if Visa.count > 0
         defaultref = Visa.last.ref_num + 1  
      end
      ...
      :o_flight_vessel, :o_air_sea_port, :o_date_entry, :passportpath, :idcardpath, :photopath).merge(ref_num: defaultref)
    end
